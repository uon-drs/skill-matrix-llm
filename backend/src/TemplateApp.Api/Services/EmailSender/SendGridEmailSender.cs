...
public class SendGridEmailSender : IEmailSender
{
  ...
  ) where TModel : class
  {
    ...
    {
      From = new SendGrid.Helpers.Mail.EmailAddress(_config.FromAddress, _config.FromName),
      ReplyTo = new SendGrid.Helpers.Mail.EmailAddress(_config.ReplyToAddress),
