...
public class TeamServiceControllerTests(ApiFactory factory) : IClassFixture<ApiFactory>, IAsyncLifetime
{
    ...
    private ProjectEntity SeedProject(AppDbContext db, UserEntity owner, ProjectStatus status = ProjectStatus.Open)
    {
    ...
    private TeamEntity SeedTeam(AppDbContext db, ProjectEntity project, TeamStatus status = TeamStatus.Proposed)
    {
